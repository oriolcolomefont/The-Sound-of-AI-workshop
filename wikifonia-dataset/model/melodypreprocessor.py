...
class MelodyPreprocessor:
    ...
    def __init__(self, dataset_json_path,  batch_size=32):
        """
        ...
        with open(self.data_set["token_list"], "r") as f:
            self.token_list = json.load(f)
        self.batch_size = batch_size
        self.tokenizer = Tokenizer(filters="", lower=False, split=",")
        self.max_melody_length = self.data_set["max_melody_length"]
        self.number_of_tokens = len(self.token_list)
    ...
    def create_training_dataset(self):
        ...
        parsed_melodies = [self._parse_song(melody) for melody in dataset]
    ...
    def _parse_song(self, song_str):
        ...
        Parameters:
            song_str (str): A string representation of a melody.
